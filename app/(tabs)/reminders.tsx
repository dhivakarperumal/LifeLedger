...
export default function RemindersScreen() {
  ...
  const [selectedRemindersList, setSelectedRemindersList] = useState<
    Reminder[]
  >([]);
  ...
  const REMINDER_FILTER_GROUPS = [
    {
      key: "type",
      label: "Event Type",
      options: ["Birthday", "Meeting", "Bill", "Task", "Goal", "Other"],
      multi: true,
    },
  ];
  const [filterVisible, setFilterVisible] = useState(false);
  const [filterState, setFilterState] = useState<FilterState>(
    defaultFilterState(REMINDER_FILTER_GROUPS),
  );
  ...
  const getDisplayedReminders = (): Reminder[] => {
    ...
    if (quickView === "today")
      base = reminders.filter((r: any) => r.date === today);
    ...
    >
      <View style={{ flex: 1, backgroundColor: "#f9fafb" }}>
        ...
        <Calendar
          ...
          onDayPress={(day: any) => {
            ...
            const dayReminders = reminders.filter(
              (r: Reminder) => r.date === day.dateString,
            );
        ...
        >
          <View style={{ flexDirection: "row", gap: 10, marginBottom: 20 }}>
            {(
              ["selected", "today", "upcoming", "completed"] as QuickView[]
            ).map((tab) => (
              <TouchableOpacity
                key={tab}
              ...
              >
                <Text
                  style={{
                    ...
                    color: quickView === tab ? "white" : "#6b7280",
                  }}
                >
                  {tab}
                </Text>
          ...
          >
            {displayedReminders.length === 0 ? (
              <View style={{ alignItems: "center", marginTop: 40 }}>
                ...
                />
                <Text
                  style={{ color: "#9ca3af", fontWeight: "700", marginTop: 12 }}
                >
                  No reminders found
                </Text>
              </View>
              ...
              displayedReminders.map((item) => {
                const typeInfo =
                  EVENT_TYPES.find((t) => t.label === item.type) ||
                  EVENT_TYPES[5];
                return (
                  <View
                    key={item.id}
                  ...
                  >
                    ...
                    <View style={{ flexDirection: "row", gap: 8 }}>
                      ...
                      <TouchableOpacity
                        ...
                        style={{
                          padding: 8,
                          backgroundColor: loading ? "#f1f5f9" : "#fef2f2",
                          borderRadius: 10,
                        }}
                      >
                        {loading ? (
                ...
                >
                    ...
                    {EVENT_TYPES.map((t) => (
                      <TouchableOpacity
                        ...
                        style={{
                          ...
                          marginRight: 10,
                          backgroundColor:
                            type === t.label ? t.color : "#f8fafc",
                          flexDirection: "row",
                          alignItems: "center",
                          borderWidth: 1.5,
                          borderColor: type === t.label ? t.color : "#f0f0f0",
                        }}
                      >
                        <Ionicons
                          name={t.icon as any}
                          size={16}
                          color={type === t.label ? "white" : t.color}
                          style={{ marginRight: 6 }}
                        />
                        <Text
                          style={{
                            fontSize: 12,
                            fontWeight: "800",
                            color: type === t.label ? "white" : "#374151",
                          }}
                        >
                          {t.label}
                        </Text>
                  ...
                  <View style={{ marginBottom: 20 }}>
                    <DarkDropdown
                      ...
                      onChange={(value) => setRepeat(value ?? "None")}
      ...
      {toast && (
        ...
        >
          ...
          />
          <Text
            style={{ color: "white", fontWeight: "800", fontSize: 13, flex: 1 }}
          >
            {toast.message}
          </Text>
        </Animated.View>

  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingId) {
        ...
        if (
          transferAmount >
          (selectedIncome.remainingAmount ?? selectedIncome.amount ?? 0)
        ) {
        ...
        try {
          ...
          const snap = await getDocs(
            query(
              ...
              where("__name__", "==", itemToDelete.incomeId),
            ),
          );
          if (!snap.empty) {
            const incomeData = snap.docs[0].data();
            const currentRem = Number(
              incomeData.remainingAmount ?? incomeData.amount ?? 0,
            );
      ...
      >
        ...
        <View style={{ flexDirection: "row", gap: 12, marginBottom: 16 }}>
          ...
          >
            ...
            <Text style={{ color: "#4ade80", fontSize: 22, fontWeight: "900" }}>
          ...
          >
            ...
            <Text style={{ color: "#f87171", fontSize: 22, fontWeight: "900" }}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            ...
            >
              ...
              >
                Tap the + button to allocate funds from your income
              </Text>
            </View>
          }
          renderItem={({ item }) => (
            ...
            >
              ...
              >
                <Text
                  style={{ color: "#2f5d34", fontWeight: "900", fontSize: 18 }}
                >
                    ...
                    <>
                      ...
                      <View style={{ marginBottom: 20 }}>
                        <DarkDropdown
                          ...
                          options={[
                            { label: "Select income source...", value: null },
                            ...incomeList.map((item) => ({
                      ...
                      {selectedIncome && (
                        ...
                        >
                          ...
                          >
                            Available: ₹
                            {(
                              selectedIncome.remainingAmount ??
      ...
      <Modal visible={deleteModalVisible} transparent animationType="fade">
        ...
        >
          ...
          >
            ...
            >
              Are you sure you want to delete this transfer fund? This action
              cannot be undone.
            </Text>
            <View style={{ flexDirection: "row", width: "100%", gap: 12 }}>
              ...
              >
                <Text
                  style={{ color: "#374151", fontWeight: "800", fontSize: 16 }}
                >
                  Cancel
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                style={{
                  ...
                  paddingVertical: 16,
                  borderRadius: 16,
                  backgroundColor: loading ? "#fb7185" : "#ef4444",
                  alignItems: "center",
                }}
              >
                {loading ? (
